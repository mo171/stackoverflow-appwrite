  ...
  return (
    <div className="container mx-auto px-4">
      <Particles
        ...
        refresh
      />
      <div className="relative z-10 grid grid-cols-1 gap-4 md:grid-cols-2 text-black">
        <div className="flex items-center justify-center">
          <div className="space-y-4 text-center">
            ...
            <p className="text-center text-xl font-bold leading-none tracking-tighter text-neutral-800">
            ...
            <div className="flex items-center justify-center gap-4">
              {session ? (
                ...
                <>
                  ...
                  <Link
                    href="/login"
                    className="relative rounded-full border border-neutral-300 px-8 py-3 font-medium text-black"
                  >
                    <span>Login</span>
